...
method (RFC 7636 §4.2) offers no protection against an attacker who can read
...
def create_challenge(verifier: str) -> str:
    """S256: BASE64URL(SHA256(ASCII(verifier))), unpadded — RFC 7636 §4.2."""
    digest = hashlib.sha256(verifier.encode("ascii")).digest()
    return base64.urlsafe_b64encode(digest).decode("ascii").rstrip("=")


def verify_challenge(verifier: str, challenge: str, method: str) -> bool:
    """RFC 7636 §4.6 — recompute the challenge and compare."""
