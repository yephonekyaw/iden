...
/**
 * The IDEN logo, as drawn. Inherits `currentColor` rather than carrying its own
 * purple: the lockup sits on a cream canvas in one app and a dark rail in the
 * other, and the source file's colour belongs to the favicon, not to the type
 * it stands next to.
 *
 * The bars are thin relative to the box, so this wants ~20px and up. Below that
 * use `Mark`.
 */
